...
namespace FluentHub
{
    public static class RegisterSequenceFromContainer
    {
        ...
        public static ContainerBootstrap RegisterSequence<T1>(
        ...
        public static ContainerBootstrap RegisterSequence<T1, T2>(
            this ContainerBootstrap @this
            , Action<T1, T2> lambda)
        {
            return ModuleExtension.RegisterSequence(@this, lambda.Method, () => lambda.Target);
        ...
        public static ContainerBootstrap RegisterSequence<T1, T2, T3>(
            this ContainerBootstrap @this
            , Action<T1, T2, T3> lambda)
        {
            return ModuleExtension.RegisterSequence(@this, lambda.Method, () => lambda.Target);
        }
        public static ContainerBootstrap RegisterSequence<T1, T2, T3, T4>(
            this ContainerBootstrap @this
        ...
        public static ContainerBootstrap RegisterSequence<T1, T2, T3, T4, T5>(
            this ContainerBootstrap @this
        ...
        public static ContainerBootstrap RegisterSequence<T1, T2, T3, T4, T5, T6>(
            this ContainerBootstrap @this
        ...
        public static ContainerBootstrap RegisterSequence<T1, T2, T3, T4, T5, T6, T7>(
            this ContainerBootstrap @this
        ...
        public static ContainerBootstrap RegisterSequence<T1, T2, T3, T4, T5, T6, T7, T8>(
            this ContainerBootstrap @this
        ...
        public static ContainerBootstrap RegisterInitializeSequence<T1>(
            this ContainerBootstrap @this
            , Action<T1> lambda)
        {
        ...
        public static ContainerBootstrap RegisterInitializeSequence<T1, T2>(
            this ContainerBootstrap @this
            , Action<T1, T2> lambda)
        {
            return ModuleExtension.RegisterInitializeSequence(@this, lambda.Method, () => lambda.Target);
        ...
        public static ContainerBootstrap RegisterInitializeSequence<T1, T2, T3>(
            this ContainerBootstrap @this
            , Action<T1, T2, T3> lambda)
        {
            return ModuleExtension.RegisterInitializeSequence(@this, lambda.Method, () => lambda.Target);
        ...
        public static ContainerBootstrap RegisterInitializeSequence<T1, T2, T3, T4>(
            this ContainerBootstrap @this
            , Action<T1, T2, T3, T4> lambda)
        {
            return ModuleExtension.RegisterInitializeSequence(@this, lambda.Method, () => lambda.Target);
        ...
        public static ContainerBootstrap RegisterInitializeSequence<T1, T2, T3, T4, T5>(
            this ContainerBootstrap @this
            , Action<T1, T2, T3, T4, T5> lambda)
        {
            return ModuleExtension.RegisterInitializeSequence(@this, lambda.Method, () => lambda.Target);
        ...
        public static ContainerBootstrap RegisterInitializeSequence<T1, T2, T3, T4, T5, T6>(
            this ContainerBootstrap @this
            , Action<T1, T2, T3, T4, T5, T6> lambda)
        {
            return ModuleExtension.RegisterInitializeSequence(@this, lambda.Method, () => lambda.Target);
        ...
        public static ContainerBootstrap RegisterInitializeSequence<T1, T2, T3, T4, T5, T6, T7>(
            this ContainerBootstrap @this
            , Action<T1, T2, T3, T4, T5, T6, T7> lambda)
        {
            return ModuleExtension.RegisterInitializeSequence(@this, lambda.Method, () => lambda.Target);
        ...
        public static ContainerBootstrap RegisterInitializeSequence<T1, T2, T3, T4, T5, T6, T7, T8>(
            this ContainerBootstrap @this
            , Action<T1, T2, T3, T4, T5, T6, T7, T8> lambda)
        {
            return ModuleExtension.RegisterInitializeSequence(@this, lambda.Method, () => lambda.Target);
